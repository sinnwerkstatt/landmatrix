...
from apps.editor.views import ApproveInvestorChangeView, ManageForUserView, ManageUpdatesView
...
class TestInvestorUpdate(BaseInvestorTestCase):
    ...
    def test_reporter(self):
        ...
        url = reverse('investor_update', kwargs={'investor_id': investor.investor_identifier})
