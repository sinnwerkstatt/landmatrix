...
from global_app.tests.with_client_mixin import WithClientMixin
...
class TestDealDetailView(DealsTestData, WithClientMixin, TestCase):
    ...
    def test_deal_detail_view_with_history_old_version(self):
        ...
        response = self._get_url_following_redirects('/global_app/%i_%f/' % (self.activity_identifier, hopefully_existing_timestamp))
