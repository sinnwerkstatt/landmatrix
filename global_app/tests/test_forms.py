...
from global_app.forms.change_investor_form import ChangeInvestorForm
from global_app.forms.change_primary_investor_form import ChangePrimaryInvestorForm
from global_app.forms.deal_data_source_form import AddDealDataSourceFormSet, ChangeDealDataSourceFormSet, \
