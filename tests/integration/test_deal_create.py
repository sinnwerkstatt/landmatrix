...
class TestDealCreate(ActivitiesFixtureMixin,
    ...
    def assert_deal_created(self, activity, user):
        ...
        self.assertEqual(
            200, response.status_code, msg="Latest Added Log does not work"
        )
    ...
    def test_reporter(self):
        ...
        self.assertEqual(
            200,
            response.status_code,
            msg="Manage Pending Deals/Investors of Administrator does not work",
        )
        self.assert_deal_in_list(response, activity)
        ...
        self.assertEqual(
            200,
            response.status_code,
            msg="Manage Pending Additions of Editor does not work",
        )
        self.assert_deal_in_list(response, activity, role="reporter")
        ...
        self.assertEqual(
            200,
            response.status_code,
            msg="Manage Pending Additions of Administrator does not work",
        )
        self.assert_deal_in_list(response, activity, role="reporter")
