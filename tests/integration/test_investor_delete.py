...
class TestInvestorDelete(InvestorsFixtureMixin, BaseInvestorTestCase):
    ...
    def test_reporter(self):
        ...
        url = reverse(
            "investor_delete", kwargs={"investor_id": investor.investor_identifier}
        )
    ...
    def test_editor(self):
        ...
        #    self.assertEqual([], errors)
        self.assertEqual(
            302, response.status_code, msg="Approve investor does not redirect"
        )
