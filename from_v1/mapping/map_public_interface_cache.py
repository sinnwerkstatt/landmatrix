...
#                 pi_cache = landmatrix.models.Activity(
...
#             activities.append(
#                 Activity.get_activity_for_identifier(activity_identifier)
#             )
...
#         return landmatrix.models.HistoricalActivity.objects.using(V2).filter(activity_identifier=activity_identifier)[0]
...
#     return landmatrix.models.HistoricalActivity.objects.using(V2).filter(activity_identifier=deal_id).values().aggregate(Max('version'))['version__max']
