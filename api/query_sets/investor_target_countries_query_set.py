...
class TargetCountriesForInvestorCountryQuerySet(TransnationalDealsQuerySetBase):
...
class InvestorCountriesForTargetCountryQuerySet(TransnationalDealsQuerySetBase):
    SUBQUERY_FIELDS = [
