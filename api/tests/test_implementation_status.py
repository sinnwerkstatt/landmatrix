...
class TestImplementationStatus(ApiTestFunctions, DealsTestData):
    ...
    DEAL_SIZE = 12345
    RELEVANT_ATTRIBUTES = {
        'pi_implementation_status': 'In operation (production)'
    }
    ...
    def test_with_data(self):
        ...
        self.assertEqual(float(self.DEAL_SIZE), relevant_line[0]['hectares'])
...
class TestImplementationStatusDomesticDataSource(TestImplementationStatus):
    ...
    DEAL_SCOPE = 'transnational'
    RELEVANT_ATTRIBUTES = {
        'pi_implementation_status': 'In operation (production)', 'type': 'Media report'
    }
...
class TestImplementationStatusDomesticDataSourceNot(TestImplementationStatus):
    ...
    DEAL_SCOPE = 'transnational'
    RELEVANT_ATTRIBUTES = {
        'pi_implementation_status': 'In operation (production)', 'type': 'NOT Media report'
    }
