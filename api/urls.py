...
urlpatterns = [
    ...
    url(r'^deals\.json',
        ...
        name='deals_api'),
    url(r'^filter\.json',
        ManageFilterView.as_view(),
        {'format': 'json'},
        name='api_filter'),
    url(r'^filter/clear/',
        ClearFilterView.as_view(),
        {'format': 'json'},
        name='api_filter'),
    ...
    url(r'^investors\.json',
        ...
        {'format': 'json'},
        name='investors_api'),
    url(r'^latest_changes\.json',
        LatestChangesListView.as_view(),
        {'format': 'json'},
        name='latest_changes_api'),
    url(r'^logging\.json',
        LoggingView.as_view(),
        {'format': 'json'},
        name='logging_api'),
    ...
    url(r'^statistics\.json',
        StatisticsListView.as_view(),
        {'format': 'json'},
        name='statistics_api'),
    url(r'^users\.json',
