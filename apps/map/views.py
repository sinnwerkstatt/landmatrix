        ...
        return collections.OrderedDict(
            {
                "contract_area": {
                    ...
                    "color": "#575757",
                    "url": reverse(
                        "polygon_geom_api", kwargs={"polygon_field": "contract_area"}
                    ),
                },
                "intended_area": {
                    ...
                    "color": "#AD2323",
                    "url": reverse(
                        "polygon_geom_api", kwargs={"polygon_field": "intended_area"}
                    ),
                },
                "production_area": {
                    ...
                    "color": "#1D6914",
                    "url": reverse(
                        "polygon_geom_api", kwargs={"polygon_field": "production_area"}
                    ),
                },
            }
        )
    ...
    def get_context_data(self, **kwargs):
        ...
        if "country" in filters:
            ...
            with contextlib.suppress(Country.DoesNotExist, ValueError):
                context["map_object"] = Country.objects.defer("geom").get(
                    pk=target_country_id
                )
