    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operating_company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='newModel_deals', to='landmatrix.investor')),
                ('parent_companies', models.ManyToManyField(blank=True, related_name='newModel_child_deals', to='landmatrix.investor', verbose_name='Parent companies')),
                ...
                ('top_investors', models.ManyToManyField(blank=True, related_name='+', to='landmatrix.investor', verbose_name='Top parent companies')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='dealhull',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='newModel_dealHulls', to='landmatrix.country', verbose_name='Target country'),
        ),
        migrations.AddField(
            model_name='dealhull',
            name='created_by',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['dealversion', 'nid'], name='new_model_d_dealver_8782d3_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='datasource',
            unique_together={('dealversion', 'nid')},
