...
ALL_CLASSIFICATION_CHOICES = BLANK_CHOICE_DASH + list(
    HistoricalInvestor.CLASSIFICATION_CHOICES
)
...
class BaseInvestorForm(BaseModelForm):
    ...
    classification = forms.ChoiceField(
        required=False, label=_("Classification"), choices=ALL_CLASSIFICATION_CHOICES
    )
