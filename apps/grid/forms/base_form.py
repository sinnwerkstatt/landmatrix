...
from apps.grid.fields import (ActorsField, AreaField, MultiCharField, NestedMultipleChoiceField, YearBasedField)
            ...
            for value in data.split('#'):
                ...
                if date_values:
                    ...
                    if len(date_values) > 1:
                        ...
                        if value2:
                            value += _(' (%s %s)') % (value2, hasattr(field, 'placeholder') and field.placeholder or 'ha')
                else:
                    value = ''
                if value:
                    values.append(value)
    ...
    def get_display_value_model_choice_field(self, field, field_name):
        ...
        if value:
            ...
            if field_name in ('operational_stakeholder', 'fk_investor'):
                url = reverse('investor_detail', kwargs={
