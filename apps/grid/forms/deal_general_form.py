...
class DealGeneralForm(BaseForm):
    ...
    CONTRACT_FARMING_CHOICES = (("Yes", _("Yes")), ("No", _("No")))

    form_title = _("General info")

    # Land area
    tg_land_area = TitleField(required=False, label="", initial=_("Land area"))
    intended_size = forms.FloatField(
        localize=True,
        required=False,
        label=_("Intended size (in ha)"),
        help_text=_("ha"),
    ...
    tg_nature_comment = forms.CharField(
        required=False, label=_("Comment on nature of the deal"), widget=CommentInput
    )
    ...
    tg_purchase_price_comment = forms.CharField(
        required=False, label=_("Comment on purchase price"), widget=CommentInput
    )
    ...
    contract_farming = forms.ChoiceField(
        ...
        choices=CONTRACT_FARMING_CHOICES,
    ...
    on_the_lease_area = YearBasedIntegerField(
        required=False,
        label=_("On leased / purchased area (in ha)"),
        help_text=_("ha"),
        placeholder=_("Size"),
    )
    ...
    on_the_lease_households = YearBasedIntegerField(
        required=False,
        label=_("On leased / purchased households"),
    ...
    off_the_lease_area = YearBasedIntegerField(
        required=False,
        label=_("Not on leased / purchased area (out-grower, in ha)"),
        help_text=_("ha"),
        placeholder=_("Size"),
    )
    ...
    tg_contract_farming_comment = forms.CharField(
        required=False, label=_("Comment on contract farming"), widget=CommentInput
    )
