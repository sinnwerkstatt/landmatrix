...
class DealDataSourceFormTestCase(BaseDealTestCase):
    ...
    def setUp(self):
        ...
        self.files = {
            "file-new": SimpleUploadedFile(
                "file 1.pdf", b"123", content_type="application/pdf"
            )
        }
        self.data = {
            "file": "file 1.pdf",
...
class AddDealDataSourceFormSetTestCase(ActivitiesFixtureMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.request.FILES = {"data_source-0-file-new": self.file}
        self.initial = [
            {
                "file": "file 1.pdf",
                "file_not_public": True,
    ...
    def test_get_attributes(self):
        formset = self.formset(
            data=self.data, files=self.request.FILES, prefix="data_source"
        )
