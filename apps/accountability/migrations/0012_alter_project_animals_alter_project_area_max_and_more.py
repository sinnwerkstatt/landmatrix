# Generated by Django 5.0.4 on 2024-07-29 11:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accountability', '0011_alter_dealvariable_assignee_project'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='project',
            name='animals',
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('AQU', 'Aquaculture (animals)'), ('BEE', 'Beef Cattle'), ('CTL', 'Cattle'), ('DCT', 'Dairy Cattle'), ('FSH', 'Fish'), ('GOT', 'Goats'), ('OTH', 'Other livestock'), ('PIG', 'Pork'), ('POU', 'Poultry'), ('SHP', 'Sheep'), ('SHR', 'Shrimp')]), blank=True, null=True, size=None),
        ),
        migrations.AlterField(
            model_name='project',
            name='area_max',
        ...
        migrations.AlterField(
            ...
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('PROJECT_NOT_STARTED', 'Project not started'), ('STARTUP_PHASE', 'Startup phase (no production)'), ('IN_OPERATION', 'In operation (production)'), ('PROJECT_ABANDONED', 'Project abandoned')]), blank=True, null=True, size=None),
        ),
        migrations.AlterField(
            model_name='project',
