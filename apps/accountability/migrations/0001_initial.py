# Generated by Django 5.0.4 on 2024-08-09 10:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DealScoreVersion',
            fields=[
                ('deal_version', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='accountability_score', serialize=False, to='landmatrix.dealversion')),
                ('score', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scores', to='accountability.dealscore')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='filters', to='accountability.project')),
            ],
        ),
        migrations.CreateModel(
            name='UserInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('TO_SCORE', 'To score'), ('WAITING', 'Waiting'), ('VALIDATED', 'Validated')], default='TO_SCORE', max_length=10)),
                ('score', models.CharField(choices=[('NO_SCORE', 'No score'), ('NO_DATA', 'Insufficient data'), ('NO_VIOLATIONS', 'No violation'), ('PARTIAL_VIOLATIONS', 'Violations'), ('SEVERE_VIOLATIONS', 'Severe violations')], default='NO_SCORE', max_length=20)),
                ('scored_at', models.DateTimeField(blank=True, null=True, verbose_name='Scored at')),
                ...
                ('deal_score', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='variables', to='accountability.dealscoreversion')),
                ('scored_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('vggt_variable', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='accountability.vggtvariable')),
            ],
            options={
