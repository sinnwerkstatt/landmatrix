...
class NegotiationStatusChartViewTestCase(ChartViewTestCaseMixin, TestCase):

    viewname = "chart_negotiation_status"
    viewname_pdf = "chart_negotiation_status_pdf"


class ImplementationStatusChartViewTestCase(ChartViewTestCaseMixin, TestCase):

    viewname = "chart_implementation_status"
    viewname_pdf = "chart_implementation_status_pdf"


class IntentionAgricultureChartViewTestCase(ChartViewTestCaseMixin, TestCase):

    viewname = "chart_intention_agriculture"
    viewname_pdf = "chart_intention_agriculture_pdf"


class TransnationalDealsChartViewTestCase(ChartViewTestCaseMixin, TestCase):

    viewname = "chart_transnational_deals"
    viewname_pdf = "chart_transnational_deals_pdf"


class MapOfInvestmentsChartViewTestCase(ChartViewTestCaseMixin, TestCase):

    viewname = "chart_map_of_investments"
    viewname_pdf = "chart_map_of_investments_pdf"


class PerspectiveChartViewTestCase(ChartViewTestCaseMixin, TestCase):

    viewname = "chart_perspective"
    viewname_pdf = "chart_perspective_pdf"


class AgriculturalDriversChartViewTestCase(ChartViewTestCaseMixin, TestCase):

    viewname = "chart_agricultural_drivers"
    viewname_pdf = "chart_agricultural_drivers_pdf"


class ProduceInfoChartViewTestCase(ChartViewTestCaseMixin, TestCase):

    viewname = "chart_produce_info"
    viewname_pdf = "chart_produce_info_pdf"


class MiningChartViewTestCase(ChartViewTestCaseMixin, TestCase):

    viewname = "chart_mining"
    viewname_pdf = "chart_mining_pdf"


class LoggingChartViewTestCase(ChartViewTestCaseMixin, TestCase):

    viewname = "chart_logging"
    viewname_pdf = "chart_logging_pdf"


class ContractFarmingChartViewTestCase(ChartViewTestCaseMixin, TestCase):
