...
class DistributionTestCase(ActivitiesFixtureMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.parent_comment = ThreadedComment.objects.create(
            user_email="reporter-2@example.com",
    ...
    def test_get_recipients_for_comment_on_activity(self):
        ...
        expected = {
            "administrator-myanmar@example.com",
            "editor-asia@example.com",
            "administrator-asia@example.com",
            "editor-myanmar@example.com",
        }
    ...
    def test_send_notifications_for_comment_on_activity(self):
        send_notifications_for_comment_on_activity(
            self.comment, self.request, self.activity
        )
