...
from apps.landmatrix.models.investor import HistoricalInvestor, HistoricalInvestorVentureInvolvement
...
class ElasticSearch(object):
    ...
    def get_activity_documents(self, activity: HistoricalActivity, doc_type='deal'):
        ...
        if doc_type in ('deal', 'location', 'data_source', 'contract'):
            ...
            for a in activity.attributes.select_related('fk_group').order_by('fk_group__name', 'id'):
