...
class FilterCondition(models.Model):
    ...
    fk_rule = models.ForeignKey(
        "landmatrix.FilterPreset", related_name="conditions", on_delete=models.CASCADE
    )
    variable = models.CharField(_("Variable"), max_length=32)
    key = models.CharField(
        _("Key"), choices=KEY_CHOICES, max_length=32, default=KEY_CHOICE_VALUE
    )
...
class FilterPreset(models.Model):
    RELATION_AND = "and"
    RELATION_OR = "or"
    RELATION_CHOICES = ((RELATION_AND, _("And")), (RELATION_OR, _("Or")))
    ...
    relation = models.CharField(
        max_length=3, choices=RELATION_CHOICES, default=RELATION_AND
    )
