...
class InvestorVentureQuerySetTestCase(TestCase):
    ...
    def test_stakeholders(self):
        ...
        self.assertGreater(qs.count(), 0)
        self.assertEqual(
            {InvestorVentureInvolvement.STAKEHOLDER_ROLE},
    ...
    def test_investors(self):
        ...
        self.assertGreater(qs.count(), 0)
        self.assertEqual(
            {InvestorVentureInvolvement.INVESTOR_ROLE},
            set(qs.values_list("role", flat=True)),
        )
...
class InvestorActivityInvolvementManagerTestCase(TestCase):
    ...
    def test_get_involvements_for_activity(self):
        ...
        activity_identifiers = involvements.values_list(
            "fk_activity__activity_identifier", flat=True
        )
        self.assertEqual({1}, set(activity_identifiers))
        investor_statuses = involvements.values_list(
            "fk_investor__fk_status_id", flat=True
        )
