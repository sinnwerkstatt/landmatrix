# Generated by Django 4.2.7 on 2023-12-18 20:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('former_land_owner', apps.landmatrix.models.fields.ChoiceArrayField(base_field=models.CharField(choices=[('STATE', 'State'), ('PRIVATE_SMALLHOLDERS', 'Private (smallholder)'), ('PRIVATE_LARGE_SCALE', 'Private (larg}-scale farm)'), ('COMMUNITY', 'Community'), ('INDIGENOUS_PEOPLE', 'Indigenous people'), ('OTHER', 'Other')]), blank=True, default=list, size=None, verbose_name='Former land owner')),
        ...
        migrations.AlterField(
            ...
            field=apps.landmatrix.models.fields.ArrayField(base_field=models.CharField(choices=[('STATE', 'State'), ('PRIVATE_SMALLHOLDERS', 'Private (smallholder)'), ('PRIVATE_LARGE_SCALE', 'Private (larg}-scale farm)'), ('COMMUNITY', 'Community'), ('INDIGENOUS_PEOPLE', 'Indigenous people'), ('OTHER', 'Other')]), blank=True, null=True, size=None, verbose_name='Former land owner'),
        ),
        migrations.AlterField(
            model_name='deal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, verbose_name='Comment')),
                ('dealversion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='locations', to='landmatrix.dealversion2')),
            ],
        ),
        migrations.CreateModel(
            name='Involvement',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investor_version', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='workflowinfos', to='landmatrix.investorversion2')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, verbose_name='Comment')),
                ('investorversion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='datasources', to='landmatrix.investorversion2')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deal_version', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='workflowinfos', to='landmatrix.dealversion2')),
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('to_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dealversions', to='landmatrix.investorversion2'),
        ),
        migrations.AddField(
            model_name='dealversion2',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('open_land_contracts_id', models.CharField(blank=True, verbose_name='Open Contracting ID')),
                ('comment', models.TextField(blank=True, verbose_name='Comment')),
                ('dealversion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='datasources', to='landmatrix.dealversion2')),
            ],
        ),
        migrations.CreateModel(
            name='Contract',
            fields=[
                ...
                ('comment', models.TextField(blank=True, verbose_name='Comment')),
                ('dealversion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contracts', to='landmatrix.dealversion2')),
            ],
        ),
        migrations.CreateModel(
            name='Area',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['investorversion', 'nid'], name='landmatrix__investo_4c0451_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='investordatasource',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['dealversion', 'nid'], name='landmatrix__dealver_96b53a_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='dealdatasource',
            unique_together={('dealversion', 'nid')},
        ...
        migrations.AddIndex(
            model_name='contract',
            index=models.Index(fields=['dealversion', 'nid'], name='landmatrix__dealver_a039aa_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='contract',
            unique_together={('dealversion', 'nid')},
