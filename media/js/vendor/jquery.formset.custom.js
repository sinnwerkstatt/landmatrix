...
;(function($) {
    $.fn.formset = function(opts)
    {
        ...
        var $$ = null;
        // if only form templates existing (no initial forms)
        if ($(this).is(options.formTemplate)) {
            $$ = $(this);
        } else {
            $$ = $(this).not(options.formTemplate);
        }
        ...
        if ($$.length) {
            ...
            if (options.formTemplate) {
                ...
                template.find('input,select,textarea,label').each(function() {
                    ...
                    if (elem.attr("for")) elem.attr("for", elem.attr("for").replace(options.prefix + "-__prefix__-", ""));
                    if (elem.attr('id')) elem.attr('id', elem.attr('id').replace(options.prefix + "-__prefix__-", ""));
                    if (elem.attr('name')) elem.attr('name', elem.attr('name').replace(options.prefix + "-__prefix__-", ""));
                });
