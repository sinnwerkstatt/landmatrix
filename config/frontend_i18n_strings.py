...
_("Activated")
_("Activated by me")
_("Activates submitted version replacing currently active version")
_("Activation")
_("Add")
_("Add a deal")
_("Add GeoJSON")
...
_("by")
_("By making this information available, the Land Matrix hopes to enhance broad engagement and data exchange, facilitating the continuous improvement of the data. Find out how to get involved")
_("Cancel")
_("Case statistics")
_("Change")
...
_("Country profiles")
_("Country profiles present national-level data of large-scale land acquisitions and transactions including who the investors are, what the aim of the investment is, who the former owner was and what the land was previously used for, and what the potential benefits and impacts of the land deals are.")
...
_("Excel document")
_("Excluded")
_("Explore the map for information about land deals from global down to regional and country level.")
_("Export (%)")
...
_("General Info")
_("General info")
_("Generate your own infographics using a wide selection of charts to illustrate information about deals.")
_("Global")
_("Global Cropland")
...
_("ID or Name")
_("If you set the confidential flag, this deal will not be publicly visible anymore. If you want to keep it public, click on 'Cancel'.")
_("If you unset the confidential flag, this deal will be publicly visible once it is set active. If you want to keep it confidential, click on 'Cancel'.")
_("If your email-address is registered with Land Matrix you should receive an email shortly.")
...
_("Please note: {number} deals have multiple investor types. The full size of the deal is assigned to each investor type.")
...
_("Saving...")
_("Scope")
_("Search and filter the dataset through pre-configured entry points or drill down to single deals.")
...
_("The investor network diagram is not visible in draft mode. Go to {liveLink} to see it.")
_("This account has already been activated. You can probably log in now.")
_("This creates a completely identical copy of the deal. The copy must then be edited and adjusted to prevent identical duplicates.")
...
_("Yes")
_("Yield (tons)")
_("You are not the author of this version. Therefore, a new version will be created if you proceed.")
_("You can only change the country when no locations are defined.")
_("Your contact information will help our researchers get in touch with you for additional information. We respect and protect your privacy and anonymity, and will never share or publish your personal information. You can also write us directly at data@landmatrix.org.")
_("Your email address is confirmed. You can log in now.")
_("YYYY-MM-DD")
_("{x} deals have multiple intentions, resulting in a total of {y} intentions for {z} deals.")
