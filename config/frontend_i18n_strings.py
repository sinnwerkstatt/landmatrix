...
_("Choices")
_("Classification")
_("Clean Development Mechanism (CDM)")
_("Climate Action Reserve (CAR)")
_("Close")
...
_("Go to map")
_("Gold Standard for the Global Goals (GOLD)")
_("ha")
_("here")
_("Hide")
_("Households")
...
_("Oral agreement")
_("Other")
_("Other (please specify in a comment)")
_("Other (see comment)")
_("Overall comment")
_("Ownership share")
_("Parent companies")
...
_("Send")
_("Send a request of improvement and create a new draft version of the deal")
_("Send a request of improvement and create a new draft version of the investor")
_("Send feedback")
_("Set confidential")
_("Set password")
...
_("User information")
_("Username")
_("Verified Carbon Standard (VCS)")
_("Version")
_("Version history")
_("Water")
