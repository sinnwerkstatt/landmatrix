...
from notifications.exceptions import NotificationError, AlreadySentError
from notifications.models import NotificationEmailManager, NotificationEmail
...
class NotificationEmailTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.email_new = NotificationEmail.objects.create(to='to@example.com',
                                                          cc='cc@example.com',
                                                          bcc='bcc@example.com',
        ...
        self.email_sent = NotificationEmail.objects.create(to='reporter@example.com',
                                                           subject='SENT',
                                                           sent_status=NotificationEmail.STATUS_NEW,
                                                           template_name='comment_posted',
                                                           context=self.context)
