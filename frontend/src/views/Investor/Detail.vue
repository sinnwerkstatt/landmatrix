<template>
  ...
  <div id="investor-level" class="col-sm-6">
    ...
    <div class="slider-container col-sm-8">
      <input type="range" min="1" max="10" value="1" class="slider" id="depth" autocomplete="off">
    </div>
    <div class="col-sm-8">
      <input type="checkbox" class="show_deals" id="show_deals" checked="checked" autocomplete="off">
