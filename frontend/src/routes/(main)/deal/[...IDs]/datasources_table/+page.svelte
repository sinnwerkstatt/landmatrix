...
<!--  // import StatusField from "$components/Fields/Display2/StatusField.svelte"-->
...
<!--            <br />-->
<!--            {v.status}-->
<!--&lt;!&ndash;            <StatusField&ndash;&gt;-->
<!--&lt;!&ndash;              status={v.deal.status}&ndash;&gt;-->
<!--&lt;!&ndash;              draft_status={v.deal.draft_status}&ndash;&gt;-->
<!--&lt;!&ndash;              toString={false}&ndash;&gt;-->
<!--&lt;!&ndash;            />&ndash;&gt;-->
<!--          </div>-->
