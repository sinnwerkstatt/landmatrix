<script lang="ts">
  ...
  import JSONDateAreaChoicesField from "$components/Fields/Display2/JSONDateAreaChoicesField.svelte"
...
<section>
  ...
  <div class="mt-2 space-y-4">
    <h3 class="my-0">{$_("Intention of investment")}</h3>
