...
<div
  class="absolute bottom-0 right-0 top-0 z-10 flex bg-white/90 text-sm shadow-inner drop-shadow-[-3px_3px_1px_rgba(0,0,0,0.3)] dark:bg-gray-700 {$showContextBar
