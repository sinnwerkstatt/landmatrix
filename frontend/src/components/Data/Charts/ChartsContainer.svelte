<script lang="ts">
  ...
  let { ContextBar, children }: Props = $props()
</script>
...
<div class="relative h-full w-full p-0">
  ...
  <div class="h-full w-full">
    <div class="float-left h-full w-0 xl:w-[clamp(220px,20%,400px)]"></div>
    <div class="float-right h-full w-0 xl:w-[clamp(220px,20%,400px)]"></div>
