...
class DealWaterForm(BaseForm):
    ...
    tg_water_extraction_envisaged_comment = forms.CharField(
        required=False, label=_("Water extraction envisaged comments"),
        widget=CommentInput)
    ...
    tg_how_much_do_investors_pay_comment = forms.CharField(
        required=False,
        label=_("How much do investors pay for water comments"),
        widget=CommentInput)
    ...
    tg_water_extraction_amount_comment = forms.CharField(
        required=False, label=_("How much water is extracted comments"),
        widget=CommentInput)
    ...
    tg_use_of_irrigation_infrastructure_comment = forms.CharField(
        required=False, label=_("Use of irrigation infrastructure comments"),
        widget=CommentInput)
