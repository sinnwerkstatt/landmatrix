...
from django.forms import CharField, ModelMultipleChoiceField, ModelChoiceField, ChoiceField, MultiValueField, FileField, \
    BooleanField, DecimalField, FloatField
from django.test import TestCase

from grid.fields import TitleField, YearBasedIntegerField, FileFieldWithInitial, YearBasedMultipleChoiceIntegerField
from grid.forms.base_form import *
from landmatrix.models import Country, HistoricalActivity
...
class FieldsDisplayFormMixinTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.base_fields = {
            'tg_title': TitleField(),
            'nested_multiple_choice_field': NestedMultipleChoiceField(choices=nested_choices),
            'model_multiple_choice_field': ModelMultipleChoiceField(queryset=Country.objects.all()),
    ...
    def test_get_fields_display(self):
        ...
        display_keys = {'tg', 'nested_multiple_choice_field', 'model_multiple_choice_field',
                        'model_choice_field', 'choice_field', 'area_field', 'multi_value_field',
                        'file_field', 'boolean_field', 'char_field'}
        self.assertEqual(display_keys, set(values_dict.keys()))
        self.assertEqual('label1<br>label2.1', values_dict.get('nested_multiple_choice_field').get('value'))
        self.assertEqual('Cambodia<br>Myanmar', values_dict.get('model_multiple_choice_field').get('value'))
    ...
    def assert_equal_display_value(self, value, field_name, method=None):
        ...
        display_value = getattr(self.mixin, method)(self.base_fields.get(field_name), field_name)
    ...
    def test_get_display_value_multiple_choice_field(self):
        self.assert_equal_display_value('Cambodia<br>Myanmar', 'model_multiple_choice_field', method='get_display_value_multiple_choice_field')

    def test_get_display_value_nested_multiple_choice_field(self):
        self.assert_equal_display_value('label1<br>label2.1', 'nested_multiple_choice_field')
    ...
    def test_get_display_properties(self):
        ...
        display_keys = {'model_choice_field_display', 'nested_multiple_choice_field_display', 'boolean_field_display',
                        'model_multiple_choice_field_display', 'choice_field_display', 'multi_value_field_display'}
        self.assertEqual(display_keys, set(values_dict.keys()))
        self.assertEqual('label1|label2.1', values_dict.get('nested_multiple_choice_field_display'))
        self.assertEqual('Myanmar|Cambodia', values_dict.get('model_multiple_choice_field_display'))
        ...
        self.assertEqual('2000#current#value1|2010##value2', values_dict.get('multi_value_field_display'))
...
class BaseFormTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.data = MultiValueDict({
            'nested_multiple_choice_field': ['value1', 'value2.1', 'label2.1', 'invalid'],  # test key, value and invalid
            'model_multiple_choice_field': ['104', '116'],
            'model_choice_field': ['104'],
            'choice_field': ['value1'],
        ...
        self.attributes = {
            'nested_multiple_choice_field': [{'value': 'label1'}, {'value': 'value2.1'}, {'value': 'label2.1'}, {'value': 'invalid'}],
            'model_multiple_choice_field': [{'value': '104'}, {'value': '116'}],
            'model_choice_field': {'value': '104'},
            'choice_field': {'value': 'label1'},
            'multi_value_field_2': [{'value': 'test', 'value2': 'value1', 'date': None, 'is_current': False}],
            'multi_value_field_3a': [{'value': '1', 'value2': None, 'date': '2000', 'is_current': True}],
            'multi_value_field_3b': [{'value': '1', 'value2': None, 'date': '2000', 'is_current': False}],
            'multi_value_field_4': [{'value': 'value1', 'value2': '3000', 'date': '2000', 'is_current': True},
                                    {'value': 'value2', 'value2': '3000', 'date': '2000', 'is_current': True}],
    ...
    def test_get_attributes(self):
        ...
        attribute_keys = {'nested_multiple_choice_field', 'model_multiple_choice_field', 'model_choice_field',
                          'choice_field', 'multi_value_field_2', 'multi_value_field_3a', 'multi_value_field_3b',
                          'multi_value_field_4', 'file_field', 'decimal_field', 'float_field', 'float_field_int',
                          'char_field'}
        self.assertEqual(attribute_keys, set(attributes.keys()))
        self.assertEqual([{'value': 'label1'}, {'value': 'label2.1'}, {'value': 'label2.1'}, {'value': 'invalid'}],
                         attributes.get('nested_multiple_choice_field'))
        self.assertEqual([{'value': '104'}, {'value': '116'}], attributes.get('model_multiple_choice_field'))
        self.assertEqual({'value': '104'}, attributes.get('model_choice_field'))
        self.assertEqual({'value': 'label1'}, attributes.get('choice_field'))
        self.assertEqual([{'value': 'test', 'value2': 'value1', 'date': None, 'is_current': False}],
                         attributes.get('multi_value_field_2'))
        self.assertEqual([{'value': '1', 'value2': None, 'date': '2000', 'is_current': True}],
                         attributes.get('multi_value_field_3a'))
        self.assertEqual([{'value': '1', 'value2': None, 'date': '2000', 'is_current': False}],
                         attributes.get('multi_value_field_3b'))
        self.assertEqual([{'value': 'value1', 'value2': '3000', 'date': '2000', 'is_current': True},
                          {'value': 'value2', 'value2': '3000', 'date': '2000', 'is_current': True}],
    ...
    def test_get_data(self):
        ...
        data_keys = {'nested_multiple_choice_field', 'model_multiple_choice_field', 'model_choice_field',
                     'choice_field', 'multi_value_field_2', 'multi_value_field_3a', 'multi_value_field_3b',
                     'multi_value_field_4', 'file_field', 'decimal_field', 'float_field', 'float_field_int', 'char_field'}
        self.assertEqual(data_keys, set(data.keys()))
        self.assertEqual([['value1', 'value2.1', 'value2.1']], data.getlist('nested_multiple_choice_field'))
        ...
        self.assertEqual(['value1,value2:3000:2000:1'], data.getlist('multi_value_field_4'))
    ...
    def test_get_multiple_choice_data(self):
        self.assert_equal_field_value(['116', '104'],
                                      field_name='model_multiple_choice_field',
                                      method='get_multiple_choice_data')
        self.assert_equal_field_value(['value2.1', 'value2.1', 'value1'],
                                      field_name='nested_multiple_choice_field',
                                      method='get_multiple_choice_data')
        self.assert_equal_field_value(['value1'],
                                      field_name='choice_field',
                                      method='get_multiple_choice_data')

    def test_get_year_based_data(self):
        self.assert_equal_field_value('1:2000:1',
                                      field_name='multi_value_field_3a',
                                      method='get_year_based_data')
        self.assert_equal_field_value('test:value1',
    ...
    def test_init_with_readonly_fields(self):
        ...
        self.form = self.form()
        self.assertEqual('disabled', self.form.fields.get('choice_field').widget.attrs['disabled'])
        self.assertEqual(True, self.form.fields.get('char_field').widget.attrs['readonly'])
