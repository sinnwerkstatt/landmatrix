...
from grid.widgets.year_based_select import YearBasedSelect
...
class YearBasedChoiceField(forms.MultiValueField):
    def __init__(self, *args, **kwargs):
        ...
        kwargs["widget"] = YearBasedSelect(choices=kwargs.pop("choices"),help_text=kwargs.pop("help_text", ""),attrs={'class': 'form-control'})
