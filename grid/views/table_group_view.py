...
class TableGroupView(FilterWidgetMixin, ElasticSearchMixin, TemplateView):
    ...
    COLUMN_GROUPS = {
        ...
        "investor_country": ["operating_company_fk_country_display", "intention"],
        "investor_region": ["operating_company_region_display",],
        "intention": ["intention",],
        "crop": ["crops",],
        "year": ["year", "intention"],
...
class OldTableGroupView(FilterWidgetMixin, TemplateView):
    ...
    def get_records(self):
        ...
        queryset = ActivityQuerySet(self.request)
        query_result = queryset.all()
