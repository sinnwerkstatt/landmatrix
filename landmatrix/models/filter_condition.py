...
def get_filter_vars():
    ...
    filter_vars = [
        ...
        'contract_date', 'agreement_duration', 'implementation_status', 'purchase_price', 'purchase_price_currency',
        'purchase_price_type', 'purchase_price_area', 'annual_leasing_fee', 'annual_leasing_fee_currency',
        'annual_leasing_fee_type', 'annual_leasing_fee_area', 'contract_farming', 'on_the_lease', 'on_the_lease_area',
        'on_the_lease_farmers', 'off_the_lease', 'off_the_lease_area', 'off_the_lease_farmers', 'total_jobs_created',
        'total_jobs_planned', 'total_jobs_planned_employees', 'total_jobs_planned_daily_workers', 'total_jobs_current',
        'total_jobs_current_employees', 'total_jobs_current_daily_workers', 'foreign_jobs_created',
        'foreign_jobs_planned', 'foreign_jobs_planned_employees', 'foreign_jobs_planned_daily_workers',
        'foreign_jobs_current', 'foreign_jobs_current_employees', 'foreign_jobs_current_daily_workers',
        'domestic_jobs_created', 'domestic_jobs_planned', 'domestic_jobs_planned_employees',
        'domestic_jobs_planned_daily_workers', 'domestic_jobs_current', 'domestic_jobs_current_employees',
        'domestic_jobs_current_daily_workers', 'operational_stakeholder', 'project_name', 'type', 'url', 'file', 'date',
        'name', 'company', 'email', 'phone', 'includes_in_country_verified_information', 'community_reaction',
        'community_consultation', 'community_compensation', 'community_benefits', 'number_of_displaced_people',
        'land_owner', 'land_use', 'land_cover', 'crops', 'animals', 'minerals', 'has_domestic_use', 'domestic_use',
        'has_export', 'export', 'export_country1', 'export_country1_ratio', 'export_country2', 'export_country2_ratio',
        'export_country3', 'export_country3_ratio', 'in_country_processing', 'water_extraction_envisaged',
        'source_of_water_extraction', 'water_extraction_amount', 'fully_updated', 'fully_updated_history', 'not_public',
        'not_public_reason', 'assign_to_user'
    ]
    return filter_vars
